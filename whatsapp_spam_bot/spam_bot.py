...
position1= pt.locateOnScreen('E:/v_project/smiley.png',confidence=.6)#gets the position of the mentioned image and without confidence the program will select only those image of smiley which is 100% accurate
...
def post_response(message):
    global x,y
    position= pt.locateOnScreen('E:/v_project/smiley.png',confidence=.6)
